...
c   1-FullIns_4.cnf
c 
c parsed 'p cnf 465 6023' header
c closing input after reading 36348 bytes (35 KB)
...
c
c *  0.00  2 0  0  0   0   0 0% 0 3058 465 100%
c {  0.00  3 0  0  0   0   0 0% 0 3058 465 100%
c }  0.00  3 43  0  0   7   7 79% 6 3058 465 100%
c 1  0.00  3 43  0  0   7   7 79% 6 3058 465 100%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
v 198 199 200 -201 -202 203 -204 205 -206 -207 208 209 210 -211 -212 213 214
...
v -248 249 250 251 -252 -253 254 255 256 -257 -258 259 260 261 -262 -263 264
v 265 266 -267 -268 269 270 271 -272 -273 274 275 276 -277 -278 279 280 281
v -282 -283 284 285 -286 -287 -288 289 290 291 -292 -293 294 295 -296 -297 298
...
v -411 412 -413 -414 -415 -416 417 -418 -419 -420 -421 422 -423 -424 -425 -426
v 427 -428 -429 -430 -431 432 -433 -434 -435 -436 437 -438 -439 -440 -441 442
v -443 -444 -445 -446 447 -448 -449 -450 451 -452 -453 -454 -455 -456 457 -458
v -459 -460 -461 -462 463 464 465 0
c
c ---- [ profiling ] ---------------------------------------------------------
c
c           0.00   67.25 %  parse
...
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                                7             5181.35 per second
c decisions:                              113               16.14 per conflict
c propagations:                           627           464101    per second
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
c maximum-resident-set-size:          2662400 bytes          3 MB
c process-time:                             0s               0.00 seconds
c
c ---- [ shutting down ] -----------------------------------------------------
c
c exit 10
-- Tempo de CPU total = 0.000771 --
-- Correto:  True  --
