...
c
c *  0.00  2 0  0  0   0   0 0% 0 889 222 100%
c {  0.00  3 0  0  0   0   0 0% 0 889 222 100%
c }  0.00  3 9  0  0  50  36 32% 4 889 222 100%
c 1  0.00  3 9  0  0  50  36 32% 4 889 222 100%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
v -213 -214 -215 -216 -217 -218 -219 -220 -221 222 0
c
c ---- [ profiling ] ---------------------------------------------------------
c
c           0.00   49.83 %  search
c           0.00   35.62 %  focused
c           0.00   23.41 %  parse
...
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                               50            40192.93 per second
c decisions:                               97                1.94 per conflict
c propagations:                          1075           864148    per second
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
