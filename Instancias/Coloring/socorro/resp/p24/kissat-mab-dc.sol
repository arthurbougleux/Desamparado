...
c   p24.cnf
c 
c parsed 'p cnf 204 1282' header
c closing input after reading 7754 bytes (8 KB)
...
c
c *  0.00  2 0  0  0   0   0 0% 0 658 204 100%
c {  0.00  3 0  0  0   0   0 0% 0 658 204 100%
c }  0.00  3 13  0  0  13  13 41% 4 658 204 100%
c 1  0.00  3 13  0  0  13  13 41% 4 658 204 100%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
v -134 -135 -136 -137 -138 139 -140 -141 -142 -143 -144 -145 146 -147 -148
v -149 -150 -151 -152 -153 154 155 156 157 -158 -159 -160 -161 -162 -163 164
v -165 -166 -167 -168 -169 -170 171 -172 -173 -174 -175 -176 -177 178 179 180
v -181 -182 183 -184 -185 -186 -187 188 -189 -190 -191 -192 193 -194 -195 -196
v -197 -198 -199 -200 -201 -202 203 204 0
c
c ---- [ profiling ] ---------------------------------------------------------
c
c           0.00   39.21 %  search
c           0.00   26.21 %  parse
c           0.00   20.04 %  focused
...
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                               13            11796.73 per second
c decisions:                               63                4.85 per conflict
c propagations:                           390           353902    per second
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
