...
c
c *  0.00  2 0  0  0   0   0 0% 0 3450 600 100%
c {  0.00  3 0  0  0   0   0 0% 0 3450 600 100%
c -  0.00  3 20  1  0 303  84 29% 9 3450 600 100%
c u  0.00  3 30  1  2 900 484 38% 9 3450 600 100%
c -  0.00  3 30  2  2 905 180 38% 9 3450 600 100%
c }  0.01  3 27  2 15 1004 255 35% 9 3450 600 100%
c [  0.01  3 0  2 15 1004 255 0% 0 3450 600 100%
c O  0.01  3 9  2 15 1005 256 19% 8 3450 600 100%
c ]  0.01  3 37  2 15 1529 623 49% 10 3450 600 100%
c {  0.01  3 27  2 15 1529 623 35% 9 3450 600 100%
c -  0.01  3 28  3 86 1806 320 34% 10 3450 600 100%
c }  0.01  3 23  3 86 2326 652 29% 10 3450 600 100%
c 1  0.01  3 23  3 86 2326 652 29% 10 3450 600 100%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
v -586 -587 -588 -589 -590 -591 -592 -593 -594 -595 -596 597 598 599 600 0
c
c ---- [ profiling ] ---------------------------------------------------------
c
c           0.01   84.23 %  search
c           0.01   67.06 %  focused
c           0.00   16.78 %  stable
c           0.00   12.59 %  simplify
c           0.00   12.07 %  probe
c           0.00    4.38 %  reduce
c           0.00    3.95 %  vivify
c           0.00    3.37 %  transitive
c           0.00    2.81 %  failed
c           0.00    2.16 %  parse
c           0.00    1.88 %  substitute
c           0.00    0.52 %  autarky
c =============================================
c           0.01  100.00 %  total
c
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                             2326           195741.82 per second
c decisions:                             2938                1.26 per conflict
c propagations:                         99325          8358579    per second
c reductions:                               3              775    interval
c rephased:                                 1             2326    interval
c restarts:                                86               27.05 interval
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
