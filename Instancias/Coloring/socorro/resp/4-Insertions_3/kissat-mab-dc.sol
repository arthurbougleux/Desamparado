...
c 
c   4-Insertions_3.cnf
c 
c parsed 'p cnf 316 1327' header
c closing input after reading 8543 bytes (8 KB)
...
c
c *  0.00  2 0  0  0   0   0 0% 0 703 316 100%
c {  0.00  3 0  0  0   0   0 0% 0 703 316 100%
c }  0.00  3 0  0  0   0   0 0% 0 703 316 100%
c 1  0.00  3 0  0  0   0   0 0% 0 703 316 100%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
v -105 106 107 108 -109 110 111 112 -113 114 115 116 -117 118 119 120 -121 122
v 123 124 -125 126 127 128 -129 130 131 132 -133 134 135 136 -137 138 139 140
v -141 142 143 144 -145 146 147 148 -149 150 151 152 -153 154 155 156 157 -158
...
v 224 -225 226 227 228 -229 230 231 232 -233 234 235 236 -237 238 239 240 -241
...
v -308 309 -310 -311 -312 -313 314 315 316 0
c
c ---- [ profiling ] ---------------------------------------------------------
c
c           0.00   33.76 %  parse
c           0.00   27.35 %  search
c           0.00   10.26 %  focused
...
c decisions:                               92                0.00 per conflict
c propagations:                           316           405648    per second
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
