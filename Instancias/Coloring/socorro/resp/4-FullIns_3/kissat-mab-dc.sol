...
c   4-FullIns_3.cnf
c 
c parsed 'p cnf 798 7688' header
c closing input after reading 48239 bytes (47 KB)
...
c
c *  0.00  2 0  0  0   0   0 0% 0 3901 798 100%
c {  0.00  3 0  0  0   0   0 0% 0 3901 798 100%
c }  0.00  3 205  0  0  88  60 66% 5 3901 798 100%
c 1  0.00  3 205  0  0  88  60 66% 5 3901 798 100%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
v 271 272 273 -274 -275 -276 -277 278 279 280 -281 -282 -283 -284 285 286 287
v -288 -289 -290 -291 292 293 294 -295 -296 -297 -298 299 300 301 -302 -303
v -304 -305 306 307 308 -309 -310 -311 -312 313 314 315 -316 -317 -318 -319
...
v -353 -354 355 356 357 -358 -359 -360 -361 362 363 364 -365 -366 -367 -368
...
v 507 508 509 510 511 -512 -513 514 515 516 517 518 -519 -520 521 522 523 524
v 525 -526 -527 528 529 530 531 532 -533 -534 535 536 537 538 539 -540 -541
v 542 543 544 545 546 -547 -548 549 550 551 552 553 -554 -555 556 557 558 559
v 560 -561 -562 563 564 565 566 567 -568 -569 570 571 572 573 574 -575 -576
v 577 578 579 580 581 -582 -583 584 585 586 587 588 -589 -590 591 592 593 594
v 595 -596 -597 598 599 600 601 602 -603 -604 605 606 607 608 609 -610 -611
v 612 613 614 615 616 -617 -618 619 620 621 622 623 -624 -625 626 627 628 629
...
v -752 -753 -754 -755 -756 -757 -758 -759 -760 761 -762 -763 -764 765 -766
v -767 -768 -769 -770 -771 -772 773 -774 -775 -776 -777 -778 -779 -780 781
v -782 -783 -784 785 -786 -787 -788 -789 -790 -791 -792 -793 -794 -795 -796
v 797 798 0
c
c ---- [ profiling ] ---------------------------------------------------------
c
...
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                               88            51252.18 per second
c decisions:                              441                5.01 per conflict
c propagations:                          3148          1833430    per second
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
c maximum-resident-set-size:          2678784 bytes          3 MB
c process-time:                             0s               0.00 seconds
c
c ---- [ shutting down ] -----------------------------------------------------
c
c exit 10
-- Tempo de CPU total = 0.000520 --
-- Correto:  True  --
