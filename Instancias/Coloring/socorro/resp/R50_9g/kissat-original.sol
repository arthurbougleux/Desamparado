...
c closing input after reading 276863 bytes (270 KB)
...
c ]  0.06  5 24 2 1  1 1 1925 1314 1.2 23 19 16 20 74% 6815 317 1560 149%
c {  0.06  5 23 2 1  1 1 1925 1314 1.2 23 19 17 20 75% 6815 317 1560 149%
c -  0.07  5 23 2 2  1 1 2001 1326 1.2 23 19 17 20 75% 6815 317 1560 149%
c }  0.07  5 21 3 2  1 1 2925 2113 1.3 22 18 17 20 74% 6815 317 1560 149%
c [  0.07  5 24 3 2  1 1 2925 2113 1.2 23 19 16 20 74% 6815 317 1560 149%
c W  0.07  5 24 3 2  1 1 2925 2113 1.2 23 19 16 20 74% 6815 317 1560 149%
c u  0.08  5 38 3 2  1 2 3092 1758 1.3 29 22 16 20 75% 6815 317 1560 149%
c v  0.08  5 38 3 2  1 2 3092 1392 1.3 29 22 16 20 75% 6815 317 1560 149%
...
c w  0.10  5 38 3 2  1 2 3092 1250 1.3 29 22 16 20 75% 6116 317 1972 188%
c -  0.12  5 47 3 3  1 2 3417 1390 1.3 35 26 17 36 75% 6116 317 1972 188%
c ]  0.13  5 51 4 3  1 2 3903 1804 1.3 38 29 17 36 75% 6116 317 1972 188%
c {  0.13  5 21 4 3  1 1 3903 1804 1.3 22 18 17 20 74% 6116 317 1972 188%
...
c           0.07   51.00 %  probe
c           0.05   33.75 %  search
c           0.04   32.40 %  preprocess
c           0.04   32.09 %  simplify
c           0.04   26.08 %  sweep
c           0.02   17.75 %  focused
c           0.02   16.00 %  stable
c           0.02   14.32 %  vivify
c           0.02   12.54 %  fastel
c           0.01    5.56 %  factor
c           0.00    1.51 %  transitive
c           0.00    1.43 %  backbone
c           0.00    1.35 %  parse
c           0.00    1.13 %  substitute
c           0.00    0.96 %  congruence
c           0.00    0.89 %  walking
c           0.00    0.60 %  reduce
c           0.00    0.18 %  lucky
c           0.00    0.02 %  extend
...
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                             4116            29849.45 per second
...
c propagations:                       1266786          9186798    per second
...
c ---- [ resources ] ---------------------------------------------------------
c
c maximum-resident-set-size:          5369856 bytes          5 MB
c process-time:                                              0.14 seconds
c
c ---- [ shutting down ] -----------------------------------------------------
c
c exit 10
-- Tempo de CPU total = 0.136121 --
-- Correto:  True  --
