...
c
c *  0.00  3 0  0  0   0   0 0% 0 22982 1050 100%
c {  0.00  3 0  0  0   0   0 0% 0 22982 1050 100%
c -  0.01  4 23  1  0 302  52 88% 20 22982 1050 100%
c -  0.01  4 24  2 13 902 104 86% 21 22982 1050 100%
c }  0.01  4 24  2 13 1000 167 87% 21 22982 1050 100%
c [  0.01  4 0  2 13 1000 167 0% 0 22982 1050 100%
c O  0.01  4 38  2 13 1002 169 91% 20 22982 1050 100%
c -  0.02  4 25  3 13 1803 155 83% 21 22982 1050 100%
c ]  0.03  4 25  3 13 1937 261 84% 21 22982 1050 100%
c {  0.03  4 24  3 13 1937 261 87% 21 22982 1050 100%
c I  0.04  4 25  3 31 3003 896 83% 22 22982 1050 100%
c -  0.04  4 26  4 31 3007 228 83% 22 22982 1050 100%
c }  0.04  4 27  4 48 3040 255 82% 23 22982 1050 100%
c 1  0.04  4 27  4 48 3040 255 82% 23 22982 1050 100%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
c
c           0.03   73.68 %  search
c           0.02   58.19 %  focused
c           0.01   18.29 %  simplify
c           0.01   17.49 %  probe
c           0.01   15.26 %  stable
c           0.00   11.90 %  transitive
c           0.00    7.35 %  parse
c           0.00    3.91 %  reduce
c           0.00    3.21 %  failed
c           0.00    2.16 %  substitute
c           0.00    0.80 %  autarky
c           0.00    0.21 %  vivify
c =============================================
c           0.04  100.00 %  total
...
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                             3040            83317.35 per second
c decisions:                             4062                1.34 per conflict
c propagations:                       1188273         32567024    per second
c reductions:                               4              760    interval
c rephased:                                 2             1520    interval
c restarts:                                48               63.33 interval
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
c maximum-resident-set-size:          4194304 bytes          4 MB
c process-time:                             0s               0.04 seconds
c
c ---- [ shutting down ] -----------------------------------------------------
c
c exit 10
-- Tempo de CPU total = 0.033767 --
-- Correto:  True  --
