...
c   GEOM30b.cnf
c 
c parsed 'p cnf 150 840' header
c closing input after reading 4933 bytes (5 KB)
...
c
c *  0.00  2 0  0  0   0   0 0% 0 435 150 99%
c {  0.00  2 0  0  0   0   0 0% 0 435 150 99%
c }  0.00  2 12  0  0   7   7 56% 4 435 150 99%
c 1  0.00  2 12  0  0   7   7 56% 4 435 150 99%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
v -135 -136 -137 -138 139 140 -141 -142 -143 144 145 -146 -147 -148 149 150 0
c
c ---- [ profiling ] ---------------------------------------------------------
c
c           0.00   37.26 %  search
c           0.00   23.56 %  parse
c           0.00   19.18 %  focused
...
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                                7             5967.60 per second
c decisions:                               39                5.57 per conflict
c propagations:                           235           200341    per second
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
