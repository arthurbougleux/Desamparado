...
c   p16.cnf
c 
c parsed 'p cnf 204 1642' header
c closing input after reading 9671 bytes (9 KB)
...
c
c *  0.00  2 0  0  0   0   0 0% 0 838 204 100%
c {  0.00  3 0  0  0   0   0 0% 0 838 204 100%
c }  0.00  3 6  0  0  10  10 30% 3 838 204 100%
c 1  0.00  3 6  0  0  10  10 30% 3 838 204 100%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
v -198 -199 -200 -201 -202 203 204 0
c
c ---- [ profiling ] ---------------------------------------------------------
c
c           0.00   34.15 %  search
c           0.00   29.93 %  parse
c           0.00   18.63 %  focused
...
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                               10             9337.07 per second
c decisions:                               43                4.30 per conflict
c propagations:                           367           342670    per second
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
