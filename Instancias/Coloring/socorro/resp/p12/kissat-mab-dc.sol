...
c   p12.cnf
c 
c parsed 'p cnf 130 926' header
c closing input after reading 5239 bytes (5 KB)
...
c
c *  0.00  2 0  0  0   0   0 0% 0 476 130 99%
c {  0.00  3 0  0  0   0   0 0% 0 476 130 99%
c }  0.00  3 8  0  0  12  12 48% 2 476 130 99%
c 1  0.00  3 8  0  0  12  12 48% 2 476 130 99%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
v -118 -119 -120 121 -122 -123 -124 -125 -126 -127 -128 -129 130 0
c
c ---- [ profiling ] ---------------------------------------------------------
c
c           0.00   40.48 %  search
c           0.00   21.43 %  parse
c           0.00   20.00 %  focused
...
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                               12            11235.96 per second
c decisions:                               41                3.42 per conflict
c propagations:                           315           294944    per second
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
