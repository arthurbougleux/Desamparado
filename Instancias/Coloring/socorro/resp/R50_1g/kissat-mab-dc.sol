...
c   R50_1g.cnf
c 
c parsed 'p cnf 150 698' header
c closing input after reading 4171 bytes (4 KB)
...
c
c *  0.00  2 0  0  0   0   0 0% 0 374 150 99%
c {  0.00  3 0  0  0   0   0 0% 0 374 150 99%
c }  0.00  3 4  0  0   5   5 36% 1 374 150 99%
c 1  0.00  3 4  0  0   5   5 36% 1 374 150 99%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
v 137 -138 -139 -140 141 -142 143 -144 145 -146 -147 -148 -149 150 0
c
c ---- [ profiling ] ---------------------------------------------------------
c
c           0.00   33.17 %  search
c           0.00   23.15 %  parse
c           0.00   15.99 %  focused
...
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                                5             4488.33 per second
c decisions:                               20                4.00 per conflict
c propagations:                           272           244165    per second
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
