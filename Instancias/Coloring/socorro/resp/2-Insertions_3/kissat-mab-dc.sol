...
c 
c   2-Insertions_3.cnf
c 
c parsed 'p cnf 148 613' header
c closing input after reading 3712 bytes (4 KB)
...
c
c *  0.00  2 0  0  0   0   0 0% 0 325 148 99%
c {  0.00  3 0  0  0   0   0 0% 0 325 148 99%
c }  0.00  3 0  0  0   0   0 0% 0 325 148 99%
c 1  0.00  3 0  0  0   0   0 0% 0 325 148 99%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
v 87 88 -89 90 91 92 -93 94 95 96 -97 98 99 100 -101 102 103 104 -105 106 107
...
v -140 141 -142 -143 -144 -145 146 147 148 0
c
c ---- [ profiling ] ---------------------------------------------------------
c
c           0.00   32.49 %  search
c           0.00   25.24 %  parse
c           0.00   13.25 %  focused
...
c decisions:                               37                0.00 per conflict
c propagations:                           148           157113    per second
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
