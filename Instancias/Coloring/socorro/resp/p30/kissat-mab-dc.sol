...
c   p30.cnf
c 
c parsed 'p cnf 480 5132' header
c closing input after reading 31322 bytes (31 KB)
...
c
c *  0.00  2 0  0  0   0   0 0% 0 2596 480 100%
c {  0.00  3 0  0  0   0   0 0% 0 2596 480 100%
c -  0.00  3 30  1  0 303 160 40% 7 2596 480 100%
c }  0.00  3 30  1  0 305 162 40% 7 2596 480 100%
c 1  0.00  3 30  1  0 305 162 40% 7 2596 480 100%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
v 375 376 -377 -378 379 -380 -381 -382 -383 -384 -385 -386 -387 388 -389 -390
...
v -467 -468 469 -470 -471 -472 -473 -474 -475 -476 -477 -478 479 480 0
c
c ---- [ profiling ] ---------------------------------------------------------
c
c           0.00   78.31 %  search
c           0.00   75.42 %  focused
c           0.00   15.06 %  parse
c           0.00   11.59 %  reduce
...
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                              305           104237.87 per second
c decisions:                              441                1.45 per conflict
c propagations:                          6895          2356459    per second
c reductions:                               1              305    interval
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
