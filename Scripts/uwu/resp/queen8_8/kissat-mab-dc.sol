...
c   queen8_8.cnf
c 
c parsed 'p cnf 832 9528' header
c closing input after reading 114748 bytes (112 KB)
...
c
c *  0.00  3 0  0  0   0   0 0% 0 9528 832 100%
c {  0.00  3 0  0  0   0   0 0% 0 9528 832 100%
c -  0.00  3 16  1  0 301  58 33% 13 9528 832 100%
c }  0.01  3 17  1  4 791 330 35% 13 9528 832 100%
c 1  0.01  3 17  1  4 791 330 35% 13 9528 832 100%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
v -369 -370 -371 -372 373 -374 -375 376 377 -378 -379 -380 381 -382 -383 -384
...
v -687 -688 -689 -690 -691 -692 -693 -694 -695 -696 -697 698 699 700 701 702
...
v -793 -794 -795 -796 -797 -798 -799 800 -801 -802 -803 -804 -805 -806 -807
v -808 -809 -810 811 -812 -813 -814 -815 -816 -817 -818 -819 -820 -821 -822
v -823 -824 -825 -826 827 828 829 830 831 832 0
c
c ---- [ profiling ] ---------------------------------------------------------
c
c           0.00   80.69 %  search
c           0.00   79.67 %  focused
c           0.00   16.62 %  parse
c           0.00    6.40 %  reduce
...
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                              791           114190.85 per second
c decisions:                              905                1.14 per conflict
c propagations:                         29439          4249892    per second
c reductions:                               1              791    interval
c restarts:                                 4              197.75 interval
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
