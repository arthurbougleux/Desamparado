...
c u  0.07  4 26  5 554 5403 886 82% 17 6552 512 89%
...
c ^  0.23  5 50  8 1112 13500 3288 84% 25 6552 512 89%
c u  0.23  5 50  8 1112 13504 3284 84% 25 6552 512 89%
c -  0.24  4 50  9 1112 13510 826 84% 25 6552 512 89%
c ]  0.25  4 47  9 1112 14357 1637 84% 25 6552 512 89%
c 1  0.25  4 27  9 1112 14357 1637 86% 18 6552 512 89%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
c
c           0.21   83.36 %  search
c           0.12   49.22 %  focused
c           0.08   34.11 %  stable
c           0.04   16.25 %  simplify
c           0.02    8.37 %  walking
c           0.02    6.53 %  probe
c           0.01    2.87 %  vivify
c           0.00    1.95 %  transitive
c           0.00    1.22 %  eliminate
c           0.00    1.22 %  reduce
c           0.00    1.21 %  substitute
c           0.00    0.47 %  failed
c           0.00    0.31 %  parse
c           0.00    0.13 %  autarky
c           0.00    0.00 %  extend
...
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                            14357            57843.32 per second
c decisions:                            40978                2.85 per conflict
c propagations:                       1959091          7893036    per second
...
c ---- [ resources ] ---------------------------------------------------------
c
c maximum-resident-set-size:          4984832 bytes          5 MB
c process-time:                             0s               0.25 seconds
c
c ---- [ shutting down ] -----------------------------------------------------
c
c exit 10
-- Tempo de CPU total = 0.242455 --
-- Correto:  True  --
