...
touch $out
echo "Nome,N,M,K,Cores GBBS,Tempo GBBS,Kissat,Tempo,Kissat-Mab,Tempo,hKis,Tempo" > $out
...
for dir in $( ls -d */ ); do
    ...
    echo $inst,$n,$m,$k,$gbbs_colors,$gbbs_time,$kissat_right,$kissat_time,$mabdc_right,$mabdc_time,$hkis_right,$hKis_time >> $out
