...
c   huck.cnf
c 
c parsed 'p cnf 814 3385' header
c closing input after reading 41876 bytes (41 KB)
...
c
c *  0.00  2 0  0  0   0   0 0% 0 3385 814 100%
c {  0.00  3 0  0  0   0   0 0% 0 3385 814 100%
c -  0.00  3 88  1  0 302  66 58% 10 3385 814 100%
c u  0.01  3 75  1  0 900 415 53% 10 3385 814 100%
c -  0.01  3 75  2  0 902 141 53% 10 3385 814 100%
c }  0.01  3 65  2  0 1001 217 48% 10 3385 814 100%
c [  0.01  3 0  2  0 1001 217 0% 0 3385 814 100%
c a  0.01  3 0  2  0 1001 217 0% 0 3372 792 97%
c O  0.01  3 10  2  0 1002 218 11% 9 3372 792 97%
c ]  0.01  3 48  2  0 1483 524 50% 9 3372 792 97%
c 1  0.01  3 65  2  0 1483 524 48% 10 3372 792 97%
c
c ---- [ result ] ------------------------------------------------------------
c
s SATISFIABLE
...
v 161 162 163 164 165 -166 167 -168 -169 -170 -171 172 -173 -174 -175 -176
...
v -383 -384 385 386 387 -388 -389 -390 391 392 393 -394 395 396 397 -398 -399
...
v 493 494 495 -496 -497 -498 -499 -500 -501 -502 503 504 505 506 -507 508 -509
v -510 -511 -512 -513 -514 -515 -516 -517 -518 519 520 521 522 523 524 525 526
v 527 -528 -529 -530 -531 532 -533 -534 -535 -536 -537 -538 -539 -540 -541 542
v -543 -544 -545 -546 -547 -548 -549 -550 -551 -552 -553 -554 -555 556 557 558
v 559 560 561 562 -563 -564 -565 -566 -567 -568 -569 -570 -571 -572 -573 -574
v -575 -576 -577 578 -579 580 581 -582 583 584 585 586 587 -588 589 590 591
...
v -653 -654 -655 -656 -657 658 -659 -660 661 -662 663 664 665 666 667 668 669
...
v -720 721 722 723 724 725 726 -727 -728 -729 -730 -731 -732 -733 734 735 736
v 737 738 739 -740 -741 -742 -743 -744 -745 -746 -747 -748 -749 -750 -751 -752
v -753 -754 755 756 757 758 759 -760 761 762 763 764 765 766 767 768 769 770
v 771 -772 -773 -774 -775 -776 -777 -778 -779 -780 -781 -782 -783 -784 -785
v -786 787 788 789 790 791 792 -793 -794 -795 -796 -797 -798 799 -800 -801
v -802 -803 -804 805 -806 -807 -808 -809 -810 -811 -812 -813 -814 0
c
c ---- [ profiling ] ---------------------------------------------------------
c
c           0.01   75.74 %  search
c           0.00   56.75 %  focused
c           0.00   18.22 %  stable
c           0.00   16.59 %  simplify
c           0.00   15.16 %  probe
c           0.00    7.32 %  reduce
c           0.00    5.63 %  parse
c           0.00    4.69 %  vivify
c           0.00    4.45 %  transitive
c           0.00    3.32 %  failed
c           0.00    2.63 %  substitute
c           0.00    1.43 %  autarky
c           0.00    0.01 %  extend
c =============================================
c           0.01  100.00 %  total
...
c ---- [ statistics ] --------------------------------------------------------
c
c conflicts:                             1483           178352.38 per second
c decisions:                             1842                1.24 per conflict
c propagations:                         76221          9166687    per second
c reductions:                               2              742    interval
c rephased:                                 1             1483    interval
c MAB stats : 1 0 
c
c ---- [ resources ] ---------------------------------------------------------
c
